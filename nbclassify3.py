...
nbModel2text = codecs.open("nbmodel2.txt",encoding="utf-8")
learnList = []
priorDict = {}
conditionalProbDict = {}
reviewsDict = {}
...
featureMap = {}
for line in nbModel2text:
    li = line.split('\t')
    featureMap[li[0]] = float(li[1])
...
while j <= no_of_test:
    ...
    #sorted_ans = {}
    orderMap = {}
    fileNameTest = 'complete_corpus\\testFile\\input' + str(j) + ".txt"
    ...
    for ss in sidList:
        ...
        z+=1
    summaryFn = 'article' + str(j) + '_system1.txt'
